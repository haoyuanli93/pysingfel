...
class Detector(object):
    def __init__(self, mode="Unspecified"):
        ...
        if self.mode == "User Defined":
            print(
                "Please use self.initialize_with_detector_geometry_file(path= path of the detector geometry file) to initialize the detector object.")
    ...
    def print_detector_structure(self):
        if self.mode == "User Defined":
            print
            "Sorry, currently we can not provide information summary about user defined detectors in standard format."
        else:
